...
import { initGalaxy, animateGalaxy } from './features/galaxy.js';
...
// Init State
controlState.targetZoom = 8;
controlState.currentZoom = 8;
controlState.targetRotX = 0.5;
controlState.currentRotX = 0.5;

// Link handling for dev credit if needed
